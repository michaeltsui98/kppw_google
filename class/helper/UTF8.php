...
class UTF8 {
	 ...
	 * @param   string  $_charset    character set, defaults to Keke::$_charset
	 * @return  mixed
	 * @uses    UTF8::strip_ascii_ctrl
	 * @uses    UTF8::is_ascii
	 */
	public static function clean($var, $_charset = NULL)
	{
		if ( ! $_charset)
		{
			// Use the application character set
			$_charset = Keke::$_charset;
		}
		...
		elseif (is_string($var) AND $var !== '')
		{
			...
			if ( ! self::is_ascii($var))
			{
				...
				$var = iconv($_charset, $_charset.'//IGNORE', $var);
	...
	public static function transliterate_to_ascii($str, $case = 0)
	{
		...
		{
			require Keke::find_file('utf8', __FUNCTION__);
	...
	{
		if (UTF8::$server_utf8)
			return mb_strlen($str, Keke::$_charset);
	...
	{
		if (UTF8::$server_utf8)
			return mb_strpos($str, $search, $offset, Keke::$_charset);
	...
	{
		if (UTF8::$server_utf8)
			return mb_strrpos($str, $search, $offset, Keke::$_charset);
	...
	public static function substr($str, $offset, $length = NULL)
	{
		if (UTF8::$server_utf8)
			return ($length === NULL)
				? mb_substr($str, $offset, mb_strlen($str), Keke::$_charset)
				: mb_substr($str, $offset, $length, Keke::$_charset);
	...
	{
		if (UTF8::$server_utf8)
			return mb_strtolower($str, Keke::$_charset);
	...
	{
		if (UTF8::$server_utf8)
			return mb_strtoupper($str, Keke::$_charset);
