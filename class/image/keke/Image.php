...
abstract class Keke_Image {
	...
	public function __construct($file)
	{
		...
		{
			throw new Keke_exception('Not an image or invalid image: :file',
				array(':file' => Keke_debug::path($file)));
		}
	 ...
	 */
	public function watermark(Keke_Image $watermark, $offset_x = NULL, $offset_y = NULL, $opacity = 100)
	{
		if ($offset_x === NULL)
		{
			// Center the X offset
	...
	public function save($file = NULL, $quality = 100)
	{
		...
		if (is_file($file))
		{
			if ( ! is_writable($file))
			{
				throw new Keke_exception('File must be writable: :file',
					array(':file' => Keke_debug::path($file)));
			}
		}
		else
		{
			...
			{
				throw new Keke_exception('Directory must be writable: :directory',
					array(':directory' => Keke_debug::path($directory)));
			}
		}
	 ...
	 * @return  void
	 */
	abstract protected function _do_watermark(Keke_Image $image, $offset_x, $offset_y, $opacity);
