 ...
 *
 */
class Keke_image_gd extends Keke_image {
	...
	public static function check()
	{
		...
		{
			throw new Keke_exception('GD is either not installed or not enabled, check your configuration');
		}
		...
		{
			throw new Keke_exception('self requires GD version :required or greater, you have :version',
	...
	public function __construct($file)
	{
		...
		{
			throw new Keke_exception('Installed GD does not support :type images',
	...
	protected function _do_rotate($degrees)
	{
		if ( ! self::$_bundled)
		{
			throw new Keke_exception('This method requires :function, which is only available in the bundled version of GD',
	 ...
	 * @return  void
	 */
	protected function _do_watermark(Keke_Image $watermark, $offset_x, $offset_y, $opacity)
	{
		if ( ! self::$_bundled)
		{
			throw new Keke_exception('This method requires :function, which is only available in the bundled version of GD',
