 ...
 *
 */
class Keke_image_imagick extends Keke_image {
	...
	public static function check()
	{
		...
		{
			throw new Keke_exception('Imagick is not installed, or the extension is not loaded');
		}
	...
	protected function _do_watermark(Keke_Image $image, $offset_x, $offset_y, $opacity)
	{
	...
	protected function _get_imagetype($extension)
	{
		...
		switch ($format)
		{
			...
			break;
			default:
				throw new Keke_exception('Installed ImageMagick does not support :type images',
