 ...
 * Minify_Source
 */
//require_once MINIFY_MIN_DIR . '/Minify/Source.php';
...
class Minify {
    ...
    {
        if (is_string($cache)) {
            //require _once MINIFY_MIN_DIR . '/Minify/Cache/File.php';
    ...
    public static function serve($controller, $options = array())
    {
        if (is_string($controller)) {
            ...
            /*if (! class_exists($class, false)) {
                require_once MINIFY_MIN_DIR . "/Minify/Controller/" . str_replace('_', '/', $controller) . ".php";
            }*/
       ...
       // die(var_dump($controller));
        ...
        if (self::$_options['encodeOutput']) {
            ...
            if (self::$_options['encodeMethod'] !== null) {
                ...
                //require _once MINIFY_MIN_DIR.'/HTTP/Encoder.php';
        ...
        // check client cache
        //require _once MINIFY_MIN_DIR.'/HTTP/ConditionalGet.php';
        $cgOptions = array(
